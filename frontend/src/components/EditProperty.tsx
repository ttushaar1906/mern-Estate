...
export default function EditProperty() {
  return (
    <div>
      ...
      <Error message={"This feature is currently Unavailable"}/>
    </div>
  )
}
...
// import { MdBedroomChild, MdClose, MdLiving, MdSportsCricket } from "react-icons/md";
...
//     propertyDesc: propertyDetails?.propertyDesc,
//     // images: [{
//     //   url: "",
//     // }],
...
//     discountedPrice: propertyDetails?.discountedPrice || 0,
//     features: {
//       parking: propertyDetails?.features.parking,
//       petFriendly: propertyDetails?.features.petFriendly,
//       security: propertyDetails?.features.security,
//       swimmingPool: propertyDetails?.features.swimmingPool,
//       playGround: propertyDetails?.features.playGround,
//       garden: propertyDetails?.features.garden,
//       publicToilet: propertyDetails?.features.publicToilet,
//       clubHouse: propertyDetails?.features.clubHouse,
//       temple: propertyDetails?.features.temple,
//       balcony: propertyDetails?.features.balcony,
//       cctv: propertyDetails?.features.cctv,
//       lift: propertyDetails?.features.lift,
//       forSell: propertyDetails?.features.forSell,
//       noOfRooms: propertyDetails?.features.noOfRooms,
//       noOfRestRooms: propertyDetails?.features.noOfRestRooms,
//       noOfLivingRoom: propertyDetails?.features.noOfLivingRoom,
//       sqFt: propertyDetails?.features.sqFt,
//       propertyType: propertyDetails?.features.propertyType
//     },
//     rules: [{
//       no: "",
//       rules: ""
...
//         propertyName: propertyDetails.propertyName,
//         propertyDesc: propertyDetails.propertyDesc,
//         images: propertyDetails.images.map((img) => ({ url: img.url })),
//         address: {
//           line1: propertyDetails.address.line1,
//           line2: propertyDetails.address.line2 || "",
//           city: propertyDetails.address.city,
...
//                   <div
//                     key={item.key}
//                     className={`border rounded-lg p-3 cursor-pointer transition-all duration-200 ${formData?.features[item.key] === true
...
//                   value={propertyDetails?.features.propertyType}
//                   //  onChange={(e) =>
//                   //    setFormData((prev) => ({
//                   //      ...prev,
//                   //      features: {
...
//                   aria-label="propertySellingType"
